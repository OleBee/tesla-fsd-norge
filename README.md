...
**LAZARUS — TCMV-stemme per land (engelsk):** [https://olebee.github.io/tesla-fsd-norge/tcmv.html](https://olebee.github.io/tesla-fsd-norge/tcmv.html)
...
- [`tcmv.html`](tcmv.html) — LAZARUS: engelsk oversikt over estimert TCMV-stemme per land
...
- **LAZARUS** — daglig kl. 07.00 Europe/Oslo. Eier `tcmv.html` (engelsk TCMV-stemme per land + uoffisiell oktober-sjanse). Samme navn som siden. Rører ikke Norgesiden.
...
Synlig prosa på Norgesiden skal være vasket bokmål før publisering. `tcmv.html` (LAZARUS) er engelsk.
