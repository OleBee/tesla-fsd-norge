...
### europa.html
- **title** (42): `FSD Supervised i Europa — nyhetsfeed`
- **description** (133): `Norsk nyhetsfeed for EU artikkel 39 og TCMV rundt Tesla FSD Supervised. Poster ved materiell endring. Rykte skilles fra vedtak.`
- **og:description**: `Nyhetsfeed for artikkel 39 / TCMV. Rykte merkes separat fra myndighetsvedtak.`
...
4. **Hva skjer for Norge hvis TCMV sier ja?**  
   Norge har ikke stemmerett i TCMV. Som EØS-land følger Norge normalt EU-unntak, men Statens vegvesen kan av sikkerhetshensyn motsette seg innføring. Et EU-ja er ikke det samme som norsk kundegodkjenning samme dag.
