...
| Gen | Ca. produksjon | Sensor/regnekraft (kort) | Merknad |
|-----|----------------|----------------------|---------|
...
| **HW2.5** | ~2017 – 2019 | Forbedret/redundant regnekraft, samme 8-kamera-layout | Ofte oppgraderbar til HW3-datamaskin for FSD-kunder (historikk om pris/vilkår varierer — ikke lov nå). |
...
**Advarsel i brødtekst:** Oppgraderingsrettigheter HW2/HW2.5→HW3 har endret seg over tid. Ikke love leseren gratis oppgradering uten å sjekke egen ordre/Tesla.
...
- **Okt 2015:** Autopilot-programvare v7.0 ruller ut — første breddeaktivering av Autosteer / TACC på HW1.
  - Kilde: samtidige rapporter / Wikipedia Autopilot (sekundær); bekreft mot Tesla-blogg/utgivelsesnotater der mulig.
...
- **Des 2016 / jan 2017:** Første fase av Enhanced Autopilot på HW2 (målt/forsiktig utrulling; ikke funksjonskomplett mot gammel HW1 med én gang).
  - Kilde: Electrek 1.1.2017 (utgivelsesnotater).
...
- **Merk for Norge/EU:** Dette er **ikke** europeisk typegodkjenning. US- og EU-programvare er ikke én-til-én (RDW understreker dette senere).
...
- **Jan 2023:** HW4 begynner å leveres i refreshed Model S/Y; FSD på HW4 kommer etter hvert, ikke funksjonskomplett fra dag én.
...
- **Mars/april 2024:** Tesla dropper «FSD Beta»-navnet i utgivelsesnotatene; systemet omtales som **FSD (Supervised)** (bl.a. 2024.3.10 / v12.3.3-familien).
  - Kilde: Teslarati 31.3.2024; Drive Tesla Canada 1.4.2024 (utgivelsesnotater sitert).
...
**Callout C — USA ≠ EU**
> RDW: FSD Supervised i USA er ikke den samme programvareversjonen som i EU. Sammenlign ikke milepæler én-til-én.
...
### Primære / myndighet
1. RDW — typegodkjenning FSD Supervised (10.04.2026): https://www.rdw.nl/en/news/2026/rdw-explanation-of-european-type-approval-tesla-with-provisional-validity-in-the-netherlands
...
10. Electrek — FSD Beta-utrulling, 20.10.2020: https://electrek.co/2020/10/20/tesla-full-self-driving-beta-rollout-elon-musk-slow-cautious/
...
3. Hvor dypt på programvareversjoner (v9, v10, v11, v12, v13)? Forslag: bare navngitte milepæler med kilde (Beta 2020, Supervised 2024, HW4-native v13) — ikke full versjonstabell.
